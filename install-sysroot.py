...
REVISION_ARMEL = 'c52471d9dec240c8d0a88fa98aa1eefeee32e22f'
...
TARBALL_ARMEL = 'debian_wheezy_armel_sysroot.tgz'
...
TARBALL_ARMEL_SHA1SUM = '424710055f119e37597b89261e703423da719494'
...
def InstallSysroot(target_arch):
  ...
  if target_arch == 'amd64':
    ...
    sysroot = os.path.join(linux_dir, SYSROOT_DIR_ARMEL)
    tarball_filename = TARBALL_ARMEL
    tarball_sha1sum = TARBALL_ARMEL_SHA1SUM
    revision = REVISION_ARMEL
  else:
    raise Error('Unknown architecture: %s' % target_arch)

  url = '%s/%s/%s/%s' % (URL_PREFIX, URL_PATH, revision, tarball_filename)
  if target_arch == 'armel':
    url = 'https://github.com/solderzzc/debian-sysroot-image-creator/releases/download/v0.5.0/debian_wheezy_armel_sysroot.tgz'
